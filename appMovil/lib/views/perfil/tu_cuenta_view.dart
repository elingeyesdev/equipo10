...
class _TuCuentaViewState extends State<TuCuentaView>
  ...
  String _validarFuerza(String pass) {
    ...
    if (pass.length >= 8 &&
        ...
        pass.contains(RegExp(r'[0-9]'))) return 'Fuerte';
    return 'Media';
  }
  ...
  Future<void> _guardarDatos() async {
    if (_formDatosKey.currentState!.validate()) {
      final vm = context.read<PerfilViewModel>();
      final success = await vm.actualizarDatosPersonales(
  ...
  Future<void> _cambiarPassword() async {
    if (_formPassKey.currentState!.validate()) {
      final vm = context.read<PerfilViewModel>();
      final success =
          await vm.cambiarContrasena(_passActualCtrl.text, _passNuevaCtrl.text);
                ...
                SingleChildScrollView(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text('Información pública',
                            style: TextStyle(
