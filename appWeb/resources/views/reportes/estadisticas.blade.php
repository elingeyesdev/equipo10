        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 stats-card text-white" style="background-color: #3F7AC5;">
                <div class="card-body text-center p-4 d-flex flex-column">
                    ...
                    <a href="{{ route('estadisticas.eficacia') }}" class="btn w-100 mt-auto" style="background:white;color:#3F7AC5;font-weight:600;">Ver reporte</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 stats-card text-white" style="background-color: #5388CB;">
                <div class="card-body text-center p-4 d-flex flex-column">
                    ...
                    <a href="{{ route('estadisticas.usuarios') }}" class="btn w-100 mt-auto" style="background:white;color:#5388CB;font-weight:600;">Ver reporte</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 stats-card" style="background-color: #E9C978;">
                <div class="card-body text-center p-4 d-flex flex-column">
                    ...
                    <a href="{{ route('estadisticas.tendencias') }}" class="btn w-100 mt-auto" style="background:white;color:#2B333D;font-weight:600;">Ver reporte</a>
                </div>
            </div>
        </div>
    </div>
