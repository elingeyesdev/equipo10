...
class ReporteController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'direccion_referencia' => 'nullable|string|max:75',
            'fecha_perdida' => 'nullable|date',
            'contacto_publico' => 'boolean',
            'telefono_contacto' => 'nullable|string|size:8',
            'email_contacto' => 'nullable|email',
            'recompensa' => 'nullable|numeric|min:0|max:99999',
    ...
    {
        $validator = Validator::make($request->all(), [
            'titulo' => 'sometimes|required|string|max:25',
